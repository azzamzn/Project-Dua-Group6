...
public class WebMvcDetailTests {
    ...
    @Test
    public void testCreateDetailWithoutTotal() throws Exception {
    ...
    @Test
    public void testCreateDetailWithoutReceipt() throws Exception {
    ...
    @Test
    public void testCreateDetailWithoutMethod() throws Exception {
    ...
    @Test
    public void testCreateDetailWithoutDonation() throws Exception {
